    ...
    render() 
    {
        return (
            <div className="adminLoginComponent">
                <section className="vh-100" style={{ backgroundColor: 'papayawhip' }}>
                                ...
                                <div className="card" style={{ borderRadius: '1rem' }}>
                                    <div className="row g-0">
                                        <div className="col-md-6 col-lg-5 d-none d-md-block">
                                            <img src="./img/Admin/admin-login.jpeg" alt="Admin Logo" className="img-fluid" style={{ borderRadius: '1rem 0 0 1rem' }} />
                                        </div>
